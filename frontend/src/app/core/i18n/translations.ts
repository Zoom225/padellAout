...
export const TRANSLATIONS: Record<Locale, Partial<Record<TranslationKey, string>>> = {
  fr: {
    ...
    'landing.apiError': "Echec de l'appel API. Verifiez que le backend tourne sur le port 8081.",
  ...
  en: {
    ...
    'landing.apiError': 'API call failed. Check that the backend is running on port 8081.',
    'landing.feature1.title': 'Reservations',
